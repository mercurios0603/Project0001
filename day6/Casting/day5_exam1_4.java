...
class 칼 extends 무기 {
    ...
    public void 스킬사용() {
        System.out.printf("홍길동이/가 연속 베기 스킬을 사용합니다. 2배(%f)의 피해를 입힙니다.", 2 * damage);
    }
}
...
class 활 extends 무기 {
    ...
    public void 스킬사용() {
        System.out.printf("홍길동이/가 불화살 스킬을 사용합니다. 1.5배(%f)의 피해를 입힙니다.", 1.5 * damage);
    }
}
